...
drop if quarter != 4 // use last quarter of the year
...
* Outputs total # of insured individuals in the last quarter of each year. The
* 2024 value is used to calculate the share of individuals insured by the AOK
* in BW, Germany. See: Methodology
